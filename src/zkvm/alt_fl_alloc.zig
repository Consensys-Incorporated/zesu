...
test "sizeClass matches @clz reference at every class boundary and alignment" {
    const sizes = [_]usize{
        ...
        131072, 131073, 262143, 262144, 262145, 524287, 524288, 524289,
        1048575, 1048576, 1048577, 2097151, 2097152, 2097153, 4194303,
        4194304, 4194305, 8388607, 8388608, 8388609, 16777215, 16777216,
        16777217, 33554432,
    };
    for (sizes) |size| {
